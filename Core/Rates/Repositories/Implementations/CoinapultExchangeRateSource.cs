...
{
    public class CoinapultExchangeRateSource : IRateSource
    {
        ...
        public CoinapultExchangeRateSource(SQLiteAsyncConnection connection)
        {
        ...
        public int TypeId => (int)RateSourceId.Coinapult;
