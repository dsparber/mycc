...
namespace MyCC.Core.Tasks
{
	public static partial class ApplicationTasks
	{
		...
		public static async Task FetchBalance(Currency.Model.Currency currency, Action onStarted = null, Action onFinished = null, Action<Exception> onError = null, Action<double> progressCallback = null)
		{
			try
			{
				onStarted?.Invoke();
