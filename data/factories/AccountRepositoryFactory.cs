    ...
    public static class AccountRepositoryFactory
    {
        public static AccountRepository create(AccountRepositoryDBM repositoryDBM)
        {
            switch (repositoryDBM.Type)
            {
                ...
                case AccountRepositoryDBM.DB_TYPE_BLOCKCHAIN_REPOSITORY: return new BlockchainAccountRepository(repositoryDBM.Name, repositoryDBM.Data) { Id = repositoryDBM.Id };
                default: return null;
            }
        }
    }
