...
namespace MyCryptos.data.repositories.account
{
	public abstract class AddressAndCoinAccountRepository : OnlineAccountRepository
	{
		...
		protected AddressAndCoinAccountRepository(int type, string name, string data) : this(type, name)
		{
		...
		protected AddressAndCoinAccountRepository(int type, string name, Currency coin, string address) : this(type, name)
		{
			this.coin = coin;
