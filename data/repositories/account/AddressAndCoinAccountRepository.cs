...
namespace MyCryptos.data.repositories.account
{
	...
	{
		private readonly Currency coin;
		protected sealed override Currency Currency => coin;
		...
		protected AddressAndCoinAccountRepository(int type, string name, Currency coin, string address) : base(type, name, address)
		{
			this.coin = coin;
		}
