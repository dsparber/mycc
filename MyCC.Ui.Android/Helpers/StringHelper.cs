...
namespace MyCC.Ui.Android.Helpers
{
    public static class StringHelper
    {
        ...
        {
            return $"{Application.Context.GetString(Resource.String.LastUpdate)}: {dateTime.AsString()}";
        }
        ...
        public static string AsString(this DateTime dateTime)
        {
            ...
            if (dateTime.Date == DateTime.MinValue.Date) return Application.Context.GetString(Resource.String.Never);
