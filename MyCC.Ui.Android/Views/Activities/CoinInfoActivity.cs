...
namespace MyCC.Ui.Android.Views.Activities
{
	...
	public class CoinInfoActivity : AppCompatActivity
	{
		...
		private SortButtonFragment sortAmount, sortCurrency;
		...
		protected override void OnCreate(Bundle savedInstanceState)
		{
			...
			sortAmount = (SortButtonFragment)SupportFragmentManager.FindFragmentById(Resource.Id.button_value_sort);
			sortCurrency = (SortButtonFragment)SupportFragmentManager.FindFragmentById(Resource.Id.button_currency_sort);
		...
		private void SetReferenceTable()
		{
			...
			sortAmount.Data = ViewData.CoinInfo.SortButtons[0];
			sortCurrency.Data = ViewData.CoinInfo.SortButtons[1];
