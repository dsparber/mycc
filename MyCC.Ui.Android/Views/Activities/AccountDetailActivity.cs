...
namespace MyCC.Ui.Android.Views.Activities
{
    ...
    public class AccountDetailActivity : AppCompatActivity
    {
        ...
        private void SetData()
        {
            ...
            FindViewById<TextView>(Resource.Id.text_equal_to).Text = string.Format(Resources.GetString(Resource.String.IsEqualTo), _account.Money.ToStringTwoDigits(ApplicationSettings.RoundMoney));
