...
namespace MyCC.Forms.Tasks
{
	public static class AppTaskHelper
	{
		...
		{
			await ApplicationTasks.FetchRates(Messaging.UpdatingRates.SendStarted, Messaging.UpdatingRates.SendFinished, ErrorOverlay.Display, Messaging.Progress.Send);
		}
