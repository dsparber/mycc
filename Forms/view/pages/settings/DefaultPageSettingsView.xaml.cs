...
namespace MyCryptos.Forms.view.pages.settings
{
    public partial class DefaultPageSettingsView
    {
        ...
        private void SelectionChanged(object sender, EventArgs e)
        {
            ...
            else if (sender.Equals(ListOptionCell))
            {
                ApplicationSettings.DefaultPage = Core.Types.StartupPage.ListView;
            }
        ...
        private void UpdateCheckmarks()
        {
            ...
            ListOptionCell.ShowIcon = ApplicationSettings.DefaultPage.Equals(Core.Types.StartupPage.ListView);
        }
    }
}
