...
namespace MyCC.Forms.View.Pages
{
    public partial class AssetsGraphView
    {
        ...
        private void SetFooter()
        {
            ...
            var ratesTime = AccountStorage.NeededRatesFor(ApplicationSettings.StartupCurrencyAssets.ToCurrency()).Distinct().Select(e => RateHelper.GetRate(e)?.LastUpdate ?? DateTime.Now).DefaultIfEmpty(DateTime.Now).Min();
