...
namespace MyCC.Forms.View.Overlays
{
	public class AccountQrCodeOverlay : ContentPage
	{
		...
		public AccountQrCodeOverlay(AddressAccountRepository accountRepository)
		{
			...
			_barcodeView = new ZXingBarcodeImageView { HorizontalOptions = LayoutOptions.Center, VerticalOptions = LayoutOptions.CenterAndExpand, Margin = new Thickness(25, 0) };
			_barcodeView.BarcodeFormat = ZXing.BarcodeFormat.QR_CODE;
			_barcodeView.BarcodeOptions.Width = 200;
			_barcodeView.BarcodeOptions.Height = 200;
