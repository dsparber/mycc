...
namespace MyCC.Forms.view.components.CellViews
{
    public class SectionHeaderView : ContentView
    {
        ...
        public SectionHeaderView(bool showBorder = true)
        {
            ...
            Content = new ContentView { Content = new ContentView { Content = _label, BackgroundColor = AppConstants.TableBackgroundColor }, BackgroundColor = Color.FromHex("#ccc"), Padding = new Thickness(0, 0, 0, showBorder ? 0.5 : 0) };
        }
